...
# corresponds to decCapHighRe_t0.txt, decCapNoRe_t0.txt, unlimCapHighRe_t0.txt,
# unlimCapNoRe_t0.txt
fileInits = "decCapHighRe.txt"

# file where results will be saved
# corresponds to Figure3C_decCapHighRe.txt, Figure3C_decCapNoRe.txt,
# Figure3C_unlimCapHighRe.txt, Figure3C_unlimCapNoRe.txt
