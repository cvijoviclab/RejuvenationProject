...
# filename
    file = "../Data/rejFraction_lineage.txt"
    pic = "rejFraction_lineage.eps"
...
# set colorbar
    ...
    set cbrange [0:1]
    set cbtics 0, 0.2, 1
    set cblabel "fraction of rejuvenated cells"

# plot points
    plot file u 2:1:4 notitle with points ps 1.5 pt 7 lc palette
